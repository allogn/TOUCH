...
class LocalSpatialGridHash : public JoinAlgorithm
{
...
public:
	...
	void analyze(const SpatialObjectList& dsA,const SpatialObjectList& dsB);
        ...
        static void transferInfo(LocalSpatialGridHash* sgh, JoinAlgorithm* alg);
        ...
        void run()
        {
            ...
            double resol;
            FLAT::Vertex v;
            FLAT::Vertex::differenceVector(universe.high,universe.low,v);
            resol = (v[0]/localPartitions+v[1]/localPartitions+v[2]/localPartitions)/3.;
