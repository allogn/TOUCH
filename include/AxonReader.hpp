#ifndef AXON_READER_HPP_
#define AXON_READER_HPP_
...
namespace FLAT
{
	 ...
	 */
	class AxonReader :public SpatialObjectStream
	{
	public:
		uint64 limit;
		uint64 counter;
		...
		AxonReader(string location,uint64 max);

		AxonReader(string location,uint64 max,const Box& Universe);
