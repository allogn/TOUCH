...
void rereTOUCH::joinAtoDesB(FLAT::uint64 AID)
{
...
void rereTOUCH::joinBtoDesA(FLAT::uint64 BID)
{
    queue<FLAT::uint64> descendants;
    TreeNode* des, *ancestorNode;
...
void rereTOUCH::joinInternalobjecttodesc(FLAT::SpatialObject* obj, TreeEntry* ancestorNode, bool isA)
{
...
FLAT::uint64 rereTOUCH::mergingMbrB(TreeEntry* startEntry, FLAT::Box &mbr)
{
    TreeNode* ptr = tree[startEntry->childIndex];
    FLAT::uint64 numB=0;
