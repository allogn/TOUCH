...
allalg = [ ['cTOUCH:BU(Case4)-D1','rs-'],['cTOUCH:TD(Case1)-D1','kx-'],['dTOUCH:BU(Case4)-D1','g.--'],['dTOUCH:TD(Case1)-D1','bo:'],['reTOUCH:BU(Case4)-D1','yp-'],['reTOUCH:TD(Case1)-D1','c8:'],\
 ['cTOUCH:BU(Case4)','rs-'],['cTOUCH:TD(Case1)','kx-'],['dTOUCH:BU(Case4)','g.--'],['dTOUCH:TD(Case1)','bo:'],['reTOUCH:BU(Case4)','yp-'],['reTOUCH:TD(Case1)','c8:'] ]
